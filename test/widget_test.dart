...
void main() {
  testWidgets('State Change idle to loading', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(TestApp(currentState: ButtonState.idle,nextState: ButtonState.loading,));
  ...
  testWidgets('State Change loading to success', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(TestApp(currentState: ButtonState.loading,nextState: ButtonState.success,));
   ...
   testWidgets('State Change loading to fail', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(TestApp(currentState: ButtonState.loading,nextState: ButtonState.fail,));
    ...
    await tester.pumpWidget(TestApp(currentState: ButtonState.fail,nextState: ButtonState.idle,));
 ...
 class TestApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: ProgressButtonHomePage(currentState:currentState,nextState:nextState),
    );
  }
}
...
class ProgressButtonHomePage extends StatefulWidget {
  ...
  @override
  _ProgressButtonHomePageState createState() => _ProgressButtonHomePageState(currentState: currentState,nextState: nextState);
}
